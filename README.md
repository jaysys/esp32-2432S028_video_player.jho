...
## Command for vertical video, scale the width to at least 240, then crop the center vertically (zoom occur)
...
## Command for a vertical video of aspect ratio 4:3
ffmpeg -y -i cropped.mp4 -pix_fmt yuvj420p -q:v 7 -vf "fps=24,scale=240:320:flags=lanczos" scaled.mjpeg

## Command for a horizontal video of aspect ratio 4:3
